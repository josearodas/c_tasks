...
#the real task
for trial in range(10): #this must correspond with the number of items in runs_pool
...
np.savetxt(file_name, [('#trials','correct2','correct4','mean_storage2','mean_storage4',
    'mean_nosw2','mean_nosw4','mean_sw2','mean_sw4','raw_storage2',
    'raw_storage4','raw_nosw2','raw_nosw4','raw_sw2','raw_sw4'),
    (trials,correct2,correct4,mean_storage2,mean_storage4,mean_nosw2,mean_nosw4,
    mean_sw2,mean_sw4,str(out_resp_storage2),str(out_resp_storage4),
    str(out_resp_nosw2),str(out_resp_nosw4),str(out_resp_sw2),
    str(out_resp_sw4))],fmt='%s',delimiter=',')

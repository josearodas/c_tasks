...
txt_instr.text = "In the following task you will hear groups of digits recited very fast. After this you will be asked to recall all the last digits of the group that you can remember. You will be asked to type them in the correct order. If you cannot remember a particular item do not just skip it as it will change the position of the letter instead, try to make a guess.\n\nLet's say for example that you hear:\n\n       3-8-2-6-4-3-9-8-1-6-8-3-6-2\n\nbut you can only remember the last 5 digits. In this case when you are asked to type the digits you can remember you would type\n\n68362\n\nNotice that these digits were the last ones to be recited and are in the correct order. This is important.\n\nLet's have another example before having some practice. Please press the <space> bar."
txt_instr.draw()
win.flip()
event.waitKeys(keyList = ['space'])
win.flip()

txt_instr.text = "Let's say that you hear the numbers:\n\n         8-2-6-4-1-7-5-3-9-7-4-5\n\nand you can only remember the last 6, but you are not sure about the fourth one. In this case you would give as an answer:\n\n      539245\n\nNotice that in this case a guess was made for the digit you didn't remember and it was not just skipped. This is perfectly valid. If on the other hand, you would just have skipped it by typing 53945 you would have only scored 2, as the previous items are not on their correct position.\n\nYou will have a few practice trials so you can try for yourself how this works. If you feel the task is not sufficiently clear yet please do not hesitate to ask the researcher any doubt you have.\n\nPlease press the <space-bar> key to continue."
txt_instr.draw()
win.flip()
event.waitKeys(keyList = ['space'])
win.flip()

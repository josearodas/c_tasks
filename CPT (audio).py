...
two_ogg = sound.Sound("ogg/one.ogg")
three_ogg = sound.Sound("ogg/one.ogg")
four_ogg = sound.Sound("ogg/one.ogg")
five_ogg = sound.Sound("ogg/one.ogg")
six_ogg = sound.Sound("ogg/one.ogg")
seven_ogg = sound.Sound("ogg/one.ogg")
eight_ogg = sound.Sound("ogg/one.ogg")
nine_ogg = sound.Sound("ogg/one.ogg")
